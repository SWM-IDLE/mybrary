package kr.mybrary.authentication.domain.oauth2.service;

import java.util.Collections;
import java.util.Map;
import kr.mybrary.authentication.domain.oauth2.CustomOAuth2User;
import kr.mybrary.authentication.domain.oauth2.OAuthAttributes;
