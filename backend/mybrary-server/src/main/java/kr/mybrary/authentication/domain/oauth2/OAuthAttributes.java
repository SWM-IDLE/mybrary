package kr.mybrary.authentication.domain.oauth2;

import java.util.Map;
import java.util.UUID;
import kr.mybrary.authentication.domain.oauth2.userinfo.GoogleOAuth2UserInfo;
import kr.mybrary.authentication.domain.oauth2.userinfo.KakaoOAuth2UserInfo;
import kr.mybrary.authentication.domain.oauth2.userinfo.NaverOAuth2UserInfo;
import kr.mybrary.authentication.domain.oauth2.userinfo.OAuth2UserInfo;
import kr.mybrary.user.persistence.Role;
import kr.mybrary.user.persistence.SocialType;
