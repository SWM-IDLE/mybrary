...
import kr.mybrary.booksearch.BookSearchDtoTestData;
import kr.mybrary.booksearch.presentation.dto.response.BookSearchResultResponseElement;
import kr.mybrary.booksearch.domain.dto.BookSearchDtoMapper;
import kr.mybrary.booksearch.domain.dto.response.aladinapi.AladinBookSearchDetailResponse;
import kr.mybrary.booksearch.domain.dto.response.aladinapi.AladinBookSearchResponse;
import kr.mybrary.booksearch.domain.dto.response.aladinapi.AladinBookSearchResponse.Item;
import kr.mybrary.booksearch.domain.dto.response.kakaoapi.KakaoBookSearchResponse;
import kr.mybrary.booksearch.domain.dto.response.kakaoapi.KakaoBookSearchResponse.Document;
import kr.mybrary.booksearch.presentation.dto.response.BookSearchDetailResponse;
import kr.mybrary.booksearch.presentation.dto.response.BookSearchDetailResponse.Author;
import kr.mybrary.booksearch.presentation.dto.response.BookSearchDetailResponse.Translator;
