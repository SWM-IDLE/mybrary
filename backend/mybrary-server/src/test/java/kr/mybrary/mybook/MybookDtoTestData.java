...
import kr.mybrary.mybook.domain.dto.request.MyBookReadCompletedStatusServiceRequest;
...
import kr.mybrary.mybook.domain.dto.request.MybookUpdateServiceRequest.MybookUpdateServiceRequestBuilder;
...
import kr.mybrary.mybook.persistence.model.MyBookListDisplayElementModel.MyBookListDisplayElementModelBuilder;
import kr.mybrary.mybook.presentation.dto.request.MyBookCreateRequest;
import kr.mybrary.mybook.presentation.dto.request.MyBookUpdateRequest;
import kr.mybrary.mybook.presentation.dto.response.MyBookDetailResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookDetailResponse.BookDetailResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookElementFromMeaningTagResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookElementResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookElementResponse.BookElementResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookReadCompletedStatusResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookRegisteredStatusResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookRegistrationCountResponse;
import kr.mybrary.mybook.presentation.dto.response.MyBookUpdateResponse;
